(function($) {
  $.fn.gracket = function(method) {
    ...
    var rawData = container.data("gracket") || this.gracket.defaults.src;
    data = (typeof rawData !== "object") ? JSON.parse(rawData) : rawData;

    // Defaults => Settings
    $.fn.gracket.settings = {}

    var buildEmptyCanvas = function(id, className) {
      var _canvas = document.createElement("canvas");
      _canvas.id = id;
      _canvas.className = className;
